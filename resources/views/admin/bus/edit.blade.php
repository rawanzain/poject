                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#"> التراحيل </a>
                                </li>
                                <li class="breadcrumb-item active">تعديل ترحيل
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> تعديل ترحيل </h4>
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('bus.update' , $bus->id)}}" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$bus->name}}" id="name"
                                                               class="form-control"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="projectinput1">  رقم الرخضة </label>
                                                        <input type="text" id="name"
                                                               value="{{$bus->lience}}"
                                                               class="form-control"
                                                               placeholder="رقم الرخضة   "
                                                               name="lience">
                                                        @error("lience")
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" value="{{$bus->quantity}}" id="name"
                                                               class="form-control"
